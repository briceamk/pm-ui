...
export const mailServerReducer = createReducer(
  ...
  on(fromActions.CreateMailServer, (state, { mailServer }) => ({
    ...state,
    loading: false,
    loaded: false,
    errorMsg: null
  ...
  on(fromActions.UpdateMailServer, (state, { mailServer }) => ({
    ...state,
    loading: false,
    loaded: false,
    errorMsg: null
  ...
  on(fromActions.RemoveMailServers, (state, { ids }) => ({
    ...state,
    loading: false,
    loaded: false,
    errorMsg: null
  ...
  on(fromActions.RemoveMailServersSuccess, (state, { ids }) => {
